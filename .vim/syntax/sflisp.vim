...
syn keyword nasmStdInstruction	TFR EXG LDA LDX LDY LDSP
syn keyword nasmStdInstruction	STA STX STY STSP ANDA
syn keyword nasmStdInstruction	ORA EORA COMA COM ANDCC
syn keyword nasmStdInstruction	ORCC NOP ADDA ADCA SUBA
syn keyword nasmStdInstruction	SBCA NEGA NEG INCA INC
syn keyword nasmStdInstruction	DECA DEC CLRA CLR ASLA
syn keyword nasmStdInstruction	ASL ASRA ASR LSLA LSL
syn keyword nasmStdInstruction	LSRA LSR ROLA ROL RORA ROR
syn keyword nasmStdInstruction	CMPA CMPX CMPY CMPSP
syn keyword nasmStdInstruction	TSTA TST BITA JMP BRA BMI
syn keyword nasmStdInstruction	BPL BEQ BNE BVS BVC
syn keyword nasmStdInstruction	BCS BCC BHI BHS BEQ
syn keyword nasmStdInstruction	BNE BLS BLO BGT BGE
syn keyword nasmStdInstruction	LEAX LEAY LEASP JSR
syn keyword nasmStdInstruction	RTS RTI BSR PSHA PSHX PSHY
syn keyword nasmStdInstruction	PSHC PULA PULX PULY PULC
syn keyword nasmStdInstruction  FCB FCS RMB
